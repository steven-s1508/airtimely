// Supabase Edge Function: Update Live Data
...
export async function main(cleanup: boolean = false) {
	...
	const supabaseUrl = new Deno.env.get("SUPABASE_URL") as string;
	const supabaseServiceKey = new Deno.env.get("SERVICE_ROLE_KEY") as string;
