			...
			<View style={styles.homeHeader}>
				...
				<View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
					...
					<Input style={[styles.parkFilterInput, { flex: 1 }]}>
						<InputField placeholder="Search by park, country, or status..." placeholderTextColor={base.primary[700]} value={parkFilterInput} onChangeText={setParkFilterInput} style={styles.parkFilterInputField} />
