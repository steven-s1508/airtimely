...
import { DestinationEntry, DestinationsResponse, DestinationParkEntry } from "@/src/types/themeparksWikiApi/destinations";
import { EntityData, EntityType, EntityLocation } from "@/src/types/themeparksWikiApi/entity";
import { EntityLiveData, EntityLiveDataResponse } from "@/src/types/themeparksWikiApi/entityLive";
import { EntityScheduleResponse, ScheduleEntry } from "@/src/types/themeparksWikiApi/entitySchedule";
import { fetchDestinations, fetchEntity, fetchEntityChildren, fetchEntitySchedule } from "./themeparksApi";
import { getCountryCodeFromCoordinates } from "./nominatimApi";
...
interface DbChain {
	...
	slug: string;
	website?: string | null;
	logo_url?: string | null; // Optional, if you have logos
	created_at?: string; // TIMESTAMPTZ, auto-generated by DB
	updated_at?: string; // TIMESTAMPTZ, auto-generated by DB
}

interface DbDestinations {
...
interface DbPark {
	...
	external_id?: string | null;
	is_active: boolean;
	rcdb_url?: string | null; // Optional, if you have RCDB links
	created_at?: string; // TIMESTAMPTZ, auto-generated by DB
	updated_at?: string; // TIMESTAMPTZ, auto-generated by DB
}
...
function getChainIdForDestination(destinationName: string, chainMap: Map<string, string>): string | null {
	...
	if (nameLower.includes("walibi") || nameLower.includes("parc astérix") || nameLower.includes("bellewaerde")) return chainMap.get("compagnie-des-alpes") || null;
...
export default async function updateDbStaticData() {
	...
	const destinationsToUpsert: DbDestinations[] = [];
